...
public record UpdateMemberDto(int MemberId, string FirstName, string LastName, DateTime DateOfBirth, AddressDto Address, string Phone, string Email)
{
};
...
public class UpdateMemberDtoValidator : AbstractValidator<UpdateMemberDto>
{
    ...
    private bool BeValidDateOfBirth(UpdateMemberDto member, DateTime dateOfBirth)
    {
