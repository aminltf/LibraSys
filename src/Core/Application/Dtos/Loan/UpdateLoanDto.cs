...
public record UpdateLoanDto(int LoanId, int BookId, int MemberId, DateTime LoanDate, DateTime? ReturnDate, DateTime DueDate)
{
};
...
public class UpdateLoanDtoValidator : AbstractValidator<UpdateLoanDto>
{
    ...
    private bool BeAfterLoanDate(UpdateLoanDto loan, DateTime? returnDate)
    {
